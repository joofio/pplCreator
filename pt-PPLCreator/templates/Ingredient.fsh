...
* status = #active
* substance.code.concept = $sms#{{ns.ing_id.split(";")[idx]|trim}} "{{ns.ing_name}}"
...
* substance.strength.referenceStrength.substance.concept = $sms#{{ns.ing_id.split(";")[idx]|trim}} "{{ns.ing_name}}"
